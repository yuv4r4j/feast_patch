...
const envBadgeLabels: Record<string, string> = {
      ...
      <EuiPage paddingSize="none" style={{ background: "transparent" }}>
        ...
        >
          ...
          <EuiText size="xs" color="subdued" style={{ marginTop: 4 }}>
            <p style={{ margin: 0 }}>Powering Enterprise Data Platform</p>
          </EuiText>
          {featureFlags.environment && (
            <div style={{ marginTop: 6 }}>
              <EuiBadge color={envBadgeColors[featureFlags.environment]}>
                {envBadgeLabels[featureFlags.environment]}
              </EuiBadge>
            </div>
          )}
          <EuiSpacer size="s" />
          ...
          <EuiErrorBoundary>
            ...
            >
              ...
              <div
                style={{
                  flexShrink: 0,
                  borderTop: "1px solid var(--euiBorderColor, #D3DAE6)",
                  backgroundColor: "var(--euiPageBackgroundColor, #fff)",
                  padding: "8px 16px",
                  textAlign: "center",
                }}
              >
                <EuiText size="xs" color="subdued">
                  Internal Use Only — DTI Data Technology &amp; Innovations
                </EuiText>
              </div>
            </div>
          </EuiErrorBoundary>
