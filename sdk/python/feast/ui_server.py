...
def get_app(
    ...
    with importlib_resources.as_file(ui_dir_ref) as ui_dir:
        ...
        with ui_dir.joinpath("projects-list.json").open(mode="w") as f:
            ...
            ui_environment = os.getenv("FEAST_UI_ENVIRONMENT", "sandbox").lower()
            if ui_environment not in {"sandbox", "staging", "production"}:
                ui_environment = "sandbox"

            projects_dict = {
                "projects": discovered_projects,
                "config": {"environment": ui_environment},
            }
